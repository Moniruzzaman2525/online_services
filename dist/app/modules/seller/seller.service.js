...
const getAll = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (search) {
        andConditions.push({
            OR: seller_constants_1.sellerSearchableFields.map(field => ({
                [field]: {
                    contains: search,
                    mode: 'insensitive',
                },
    ...
    const total = yield prisma_1.default.seller.count({
        where: whereConditions,
    });
    return {
        meta: {
...
const updateById = (id, data, req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.seller.update({
        where: {
            id,
        },
        data,
