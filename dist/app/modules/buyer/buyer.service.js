...
const getAll = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.buyer.findMany({
    ...
    const total = yield prisma_1.default.buyer.count({
        where: whereConditions,
    });
    return {
        meta: {
...
const getById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.buyer.findUnique({
        where: {
            id,
        },
    });
...
const updateById = (id, data, req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.buyer.update({
        where: {
            id,
        },
        data,
